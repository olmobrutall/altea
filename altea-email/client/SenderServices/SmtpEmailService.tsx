...
import { SmtpDeliveryMethod, type SmtpEmailServiceEntity } from "../../data/EmailSenderConfiguration";
...
export default function SmtpEmailService(p: { ctx: TypeContext<SmtpEmailServiceEntity> }): React.JSX.Element {
    ...
    return (
        <div>
            ...
            {sc.value.deliveryMethod === SmtpDeliveryMethod.SpecifiedPickupDirectory &&
                <AutoLine ctx={sc.subCtx(s => s.pickupDirectoryLocation)} />}

            {sc.value.deliveryMethod === SmtpDeliveryMethod.Network &&
