...
// Copy-and-fix of Signum.Chart/D3Scripts/Components/Rule.tsx (verbatim; unused d3 import dropped). A Rule
// lays out a 1-D track into named fixed/proportional ("*") segments — the chart margin/content grid.
