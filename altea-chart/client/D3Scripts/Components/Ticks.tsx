...
// Copy-and-fix of Signum.Chart/D3Scripts/Components/Ticks.tsx. Fixes: ChartColumn is an `import type`
// (verbatimModuleSyntax); unused ChartClient namespace + ChartUtils namespace dropped. `column.type` is the
// string type name ("Number"/"Date"/…). Body otherwise verbatim.
