...
import { translate, scale } from './Components/ChartUtils';
import { toPivotTable, groupedPivotTable } from './Components/PivotTable';
import type { PivotRow } from './Components/PivotTable';
import { ChartClient } from '../ChartClient';
import type { ChartColumn, ChartScriptProps } from '../ChartClient';
          ...
          .map(r => {
            ...
            return (
              <g className="hover-group" key={key}>
                {/* Separating stroke, as on the pie: stacked neighbours share an edge, and adjacent
                    palette colours are not guaranteed to differ in luminance. */}
