...
import type { ChartTable, ChartColumn, ChartRow, ChartScriptProps } from '../ChartClient';
...
// ChartScriptHorizontalProps interface (imported by Columns/Bars/Stacked* renderers).
          ...
          .map(r => {
            ...
            return (
              <circle key={key}
                ...
                {...shapeTitle(r, [keyColumn, valueColumn])}>
              </circle>
            );
          })}
      </g>
