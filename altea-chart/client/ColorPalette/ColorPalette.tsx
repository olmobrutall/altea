...
import { ColorPaletteEntity, ColorPaletteMessage, ColorPaletteEntity_SpecificColor } from '../../data/ColorPalette'
...
//  - MList element wrappers are gone: push `Object.assign(new ColorPaletteEntity_SpecificColor(), …)` onto the plain array.
export default function ColorPalette(p: { ctx: TypeContext<ColorPaletteEntity> }): React.JSX.Element {
    ...
    async function handleMagicWand(): Promise<void> {
        ...
        if (isEnum && enumConverter != null) {
            ...
            if (step == 0) step = 1;
            ctx.value.specificColors = lites.map((e, i) => Object.assign(new ColorPaletteEntity_SpecificColor(), {
                entity: e,
        ...
        if (fewEntities != null) {
            ...
            ctx.value.specificColors = fewEntities.map((e, i) => Object.assign(new ColorPaletteEntity_SpecificColor(), {
                entity: e,
                color: colors ? colors[(i * step) % colors.length] : undefined,
            }));
            forceUpdate();
            ...
            if (chosen != null) {
                ctx.value.specificColors = chosen.map(e => Object.assign(new ColorPaletteEntity_SpecificColor(), {
                    entity: e,
                ...
                <EntityTable ctx={ctx.subCtx(e => e.specificColors)}
                    ...
                    columns={[
                        ...
                        },
                        {
                            ...
                            header: PropertyRoute.root(ColorPaletteEntity_SpecificColor).addLambda(a => a.color).fieldInfo!.niceToString(),
