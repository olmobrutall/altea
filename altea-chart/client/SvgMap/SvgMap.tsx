...
import { ChartClient, type ChartColumn, type ChartRow, type ChartScriptProps } from '../ChartClient';
...
// altea Array prototype extensions (.toObject/.distinctBy/.orderByDescending/.lastOrNull).
import '@altea/altea/data/globals/arrayExtensions';

// Copy-and-fix of Signum.Chart/SvgMap/SvgMap.tsx. altea fixes: @framework/* → @altea/altea/*
// (AppContext.toAbsoluteUrl, useAPI). Otherwise a faithful copy — the DOM/SVG plumbing is unchanged.
