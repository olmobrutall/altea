...
import { CombinedUserChartElementEmbedded, CombinedUserChartPartEntity, UserChartPartEntity } from "../data/DashboardParts";
    ...
    DashboardLogic.registerPart<CombinedUserChartPartEntity>({
        ...
        clone: p => {
            ...
            c.userCharts = (p.userCharts ?? []).map(e => {
                const row = new CombinedUserChartElementEmbedded();
