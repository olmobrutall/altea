...
// Copy-and-fix of Signum.Chart/Scripts/BubblePack.cs (see Bars.ts for the initializer note).
export class BubblePackChartScript extends ChartScript {
    constructor() {
        super(D3ChartScript.BubblePack);
        ...
        this.parameterGroups = [
            new ChartScriptParameterGroup(null, [
                new ChartScriptParameter(ChartParameter.Scale, ChartParameterType.Scala, new Scala({ zeroMax: false, minZeroMax: false, custom: false }), 1),
            ]),
            ...
            new ChartScriptParameterGroup(ChartParameterGroupMessage.Number, [
                ...
                new ChartScriptParameter(ChartParameter.NumberSizeLimit, ChartParameterType.Number, new NumberInterval({ defaultValue: 18 })),
            ...
            new ChartScriptParameterGroup(ChartParameterGroupMessage.Opacity, [
                new ChartScriptParameter(ChartParameter.FillOpacity, ChartParameterType.Number, new NumberInterval({ defaultValue: 0.8 })),
            ]),
