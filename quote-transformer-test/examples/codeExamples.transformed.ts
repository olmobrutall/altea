...
const __fileInfo = { packageName: "quote-test", fileName: "examples/codeExamples.source.ts" };
...
class Person {
    ...
    @field({ type: () => Person, nullable: true, lite: true })
    bestFriend!: Lite<Person> | null;
    @field({ type: () => Person, array: true })
    otherFriends!: Person[];
    @quoted(() => ((_this: ExParam) => ["=>", [_this], ["<", ["()", [".", [".", _this, "dateOfBirth"], "getFullYear"], []], ["c", 1950]]])(["p", "_this"]))
    isOld(): boolean {
        return this.dateOfBirth.getFullYear() < 1950;
    }
    @quoted(() => ((_this: ExParam, ol: ExParam) => ["=>", [_this, ol], ["()", ["()", ["c", asQuoted], [((x: ExParam) => ["=>", [x], ["==", [".", x, "year"], ["()", [".", [".", _this, "dateOfBirth"], "getFullYear"], []]]])(["p", "x"])]], [ol]]])(["p", "_this"], ["p", "ol"]))
