...
// on the many applications that never use isolation, so the APP declares it (`MixinDeclarations.register(DynamicTypeEntity,
// DynamicIsolationMixin)`) and the generator tolerates its absence. That is also why altea-dynamic merely DEPENDS on
