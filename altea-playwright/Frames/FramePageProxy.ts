...
export class FramePageProxy<T extends BaseEntity> extends EntityButtonContainer<T> implements AsyncScoped {
    ...
    static async create<T extends BaseEntity>(page: Page, rootType: Type<T>): Promise<FramePageProxy<T>> {
