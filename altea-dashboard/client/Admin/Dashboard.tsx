...
import {
    DashboardEntity, DashboardMessage, InteractionGroupEnum, PanelPartEmbedded, type IPartEntity,
} from "../../data/Dashboard";
...
export default function Dashboard(p: { ctx: TypeContext<DashboardEntity> }): React.JSX.Element {
    ...
    function handleOnCreate(pr: PropertyRoute): Promise<PanelPartEmbedded | undefined> {
        ...
        return SelectorModal.chooseType(contentType.typeInfos(), {
            ...
            const part = new PanelPartEmbedded();
            part.content = new (ti.ctor as unknown as new () => IPartEntity)();
            return part;
        });
    }

    function renderPart(tc: TypeContext<PanelPartEmbedded>): React.JSX.Element {
    ...
    function selectIcon(iconCtx: TypeContext<DashboardEntity | PanelPartEmbedded>): Promise<DashboardEntity | PanelPartEmbedded | undefined> {
