...
import { HealthCheckPartEntity_Item, HealthCheckPartEntity } from "../../data/Parts";
...
function HealthCheckElement(p: { element: HealthCheckPartEntity_Item }): React.JSX.Element {
