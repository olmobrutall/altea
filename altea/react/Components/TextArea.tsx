// Ported from Signum.React/Components/TextArea.tsx — copy-paste + fix (import path unchanged: ../Hooks
// resolves to altea react/Hooks, which already has useWindowEvent + whenVisible).
