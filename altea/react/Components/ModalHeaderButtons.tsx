// Ported from Signum.React/Components/ModalHeaderButtons.tsx — copy-paste + fix. altea fixes: BsColor
// from ../Components; JavascriptMessage from entities/uiMessages; classes from entities/globals.
