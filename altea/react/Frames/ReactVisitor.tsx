// Ported from Signum.React/Frames/ReactVisitor.tsx — copy-and-fix. altea fixes: import paths
...
import type { Pagination } from '../../entities/dynamicQuery/queryRequest'
...
export class ViewReplacer<T extends BaseEntity> {
  ...
  previousTypeContext(e: React.ReactElement) {
    ...
    var parentCtx = ctx.findParentCtx(getTypeName(this.ctx.value));
