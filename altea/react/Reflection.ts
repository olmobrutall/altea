...
import { TypeInfo, TypeReference, tryGetTypeInfo as alteaTryGetTypeInfo } from '../entities/reflection';
...
export { PropertyRoute, PropertyRouteType, TypeInfo, TypeReference };
