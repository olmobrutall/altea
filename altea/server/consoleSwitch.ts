...
//
// Beside SafeConsole, for the reason Signum keeps both in Utilities: a console menu is not an application's
// own code, and every altea terminal grows one. It started inside eastwind's terminal, the only thing that
// had a menu.
