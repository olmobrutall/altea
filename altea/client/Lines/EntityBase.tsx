...
export class EntityBaseController<P extends EntityBaseProps<V>, V extends BaseEntity | Lite<Entity> | null> extends LineBaseController<P, V>{
  ...
  // say WHICH line the button belongs to, but it is optional and it is a ReactNode: when it is missing or
  // is markup rather than plain text, the name has to stay the bare action instead of trailing a stray
  // space.
