...
// The widget OWN strings (tag label, remove, "no items in this list") come from ReactWidgetsLocalizer
// through the app-wide <ReactWidgetsLocalization> around the router, not react-widgets defaults.
