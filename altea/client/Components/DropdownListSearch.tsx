 ...
 * has no accessible name, and it is the element that actually takes focus: the `role="combobox"` root
 * above it carries `tabindex="-1"` when there is a filter. Unknown props DO reach that root, so this names
 * the root the ordinary way, marks it, and writes the same name onto the input underneath.
 *
 ...
 *
 * Ported from Signum.React/Components/DropdownListSearch.tsx.
 */
