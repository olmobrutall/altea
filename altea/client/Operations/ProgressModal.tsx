// Ported from Signum.React/Operations/ProgressModal.tsx — copy-and-fix. altea fixes: import paths
// (Globals→entities/globals, Signum.Entities→entities/uiMessages); dropped unused imports
// (Entity/Lite/liteKey/getTypeInfo/OperationInfo/softCast/useState); `import type { Operations }`
// (type-only, breaks the Operations.API ↔ ProgressModal cycle).
