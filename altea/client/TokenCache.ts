...
// dictionary-style access with dynamic keys), which a blob cannot enumerate and nothing in altea declares.
//
...
import {
    setServerTokensProvider, extensionSourceTypeNames, expressionSourceKeyOf, type QueryToken,
