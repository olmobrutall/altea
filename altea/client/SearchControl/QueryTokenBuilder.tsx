...
//   - the DropdownList takes react-widgets own strings ("open combobox", "There are no items in this
//     list") from the app-wide <ReactWidgetsLocalization> around the router.
