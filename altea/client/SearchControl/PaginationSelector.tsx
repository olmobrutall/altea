// Ported from Signum.React/SearchControl/PaginationSelector.tsx — copy-paste + fix. altea fixes:
//   - PaginationMode (type + niceToString companion) from entities/dynamicQueries; ResultTable/
//     Pagination/PaginateMath from ../FindOptions; toNumberFormat from ../numberFormat; classes/
...
export function PaginationComponent(p: PaginationComponentProps): React.ReactElement {
  ...
  const { currentPage, totalPages, maxButtons } = p;
