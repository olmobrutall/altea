...
export namespace Finder {
   ...
   * @param extraFilters further restrictions, by the key of that query. Unlike the domain they apply even
   * when the query carries no domain filter.
   */
  export function registerDomainForTokens<T extends Entity, D extends Entity>(type: Type<T>, getDomainField: (a: T) => Lite<D>,
    ...
    domainRegistry.set(getTypeName(type), { type, getDomainField, extraFilters });
  }
}
