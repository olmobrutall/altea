// Port of Signum's Signum.UserQueries/StringDistance.tsx (verbatim — a self-contained Levenshtein with
// edit-choice reconstruction). Used by UserQueryMenu's "Apply changes" to align the OLD stored filters/
// columns with the NEW ones from the live SearchControl, preserving row identity where they match.
