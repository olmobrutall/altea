...
import {
    UserQueryEntity, UserQueryMessage, UserQueryEntity_Column, UserQueryEntity_Order, UserQueryEntity_Filter, SystemTimeEmbedded,
} from "../data/UserQuery";
...
export namespace UserQueryMerger {
    ...
    export function mergeColumns(oldCols: UserQueryEntity_Column[], newCols: UserQueryEntity_Column[], sd: StringDistance): UserQueryEntity_Column[] {
    ...
    export function mergeFilters(
        oldFilters: UserQueryEntity_Filter[], newFilters: UserQueryEntity_Filter[],
    ...
    function distanceColumns(qc1: UserQueryEntity_Column, qc2: UserQueryEntity_Column): number {
