...
//
// The converter registry is keyed by the symbol's KEY, never by the symbol OBJECT — a symbol read back
// from the database is a FRESH instance, not the declared singleton.
