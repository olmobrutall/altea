...
import "@altea/altea/logic/dynamicQuery/tokenExpressions"; // register factories + expression prototypes
...
import { initQueryClient, setFetchServerTokens, clearServerTokenCache } from "@altea/altea/react/QueryClient";
