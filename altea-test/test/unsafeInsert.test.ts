...
describe("UnsafeInsertTest", { skip: !hasDb }, () => {
    ...
    test("InsertSimple", { skip: true }, async () => {
    ...
    test("InsertSimpleParameter", { skip: true }, async () => {
    ...
    test("InsertSimpleId", { skip: true }, async () => {
        // const value = await table(AlbumEntity).executeInsert(AlbumEntity, a => ({
        //     author: a.author, bonusTrack: a.bonusTrack, label: a.label,
    ...
    test("InsertMListSimple", { skip: true }, async () => {
    ...
    test("InsertMListParameter", { skip: true }, async () => {
        // const value = await table(AlbumEntity).flatMap(a => a.songs)
    ...
    test("InsertMListId", { skip: true }, async () => {
        // const value = await table(AlbumEntity).flatMap(a => a.songs)
    ...
    test("InsertSimpleSingle", { skip: true }, async () => {
        // const value = await table(AlbumEntity).executeInsert(AlbumEntity, a => ({
    ...
    test("InsertDistinct", { skip: true }, async () => {
    ...
    test("UnsafeInsertMyView", { skip: true }, async () => {
