...
// Port of Signum.HtmlEditor's Extensions/MentionExtension/MentionNode.tsx — verbatim. The chip round-trips
// through a `span` carrying `data-mention-key`, so the stored html keeps the KEY and not just the display
// text — which is what makes a mention resolvable later.
