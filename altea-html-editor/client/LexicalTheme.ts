// Port of Signum.HtmlEditor's LexicalTheme.ts — verbatim. Maps Lexical's node/format kinds and Prism's
// code-highlight token kinds onto the class names HtmlEditor.css styles.
export default {
    text: {
