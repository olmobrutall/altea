...
export type QuotedEx = ExConstant | ExUnary | ExBinary | ExConditional | ExProperty | ExIndex | ExCall | ExParam | ExLambda | ExObject | ExArray | ExNew | ExAs;
...
export type ExObject = ["{}", {
    [name: string]: QuotedEx;
}];
...
export type OpBinary = "**" | "*" | "/" | "%" | "+" | "-" | "<<" | ">>" | ">>>" | "<" | "<=" | ">" | ">=" | "instanceof" | "==" | "!=" | "===" | "!==" | "&" | "|" | "^" | "&&" | "||" | "??";
