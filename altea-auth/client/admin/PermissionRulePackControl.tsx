...
export default function PermissionRulePackControl({ ctx, ref }: { ctx: TypeContext<PermissionRulePack>; ref?: React.Ref<IRenderButtons & IHasChanges> }): React.JSX.Element {
