...
import { WorkflowConditionEval, type WorkflowConditionEntity } from "../../data/WorkflowCondition";
import { WorkflowClient } from "../WorkflowClient";

// Port of Signum.Workflow's Workflow/WorkflowCondition.tsx — the name, the main entity type, and the SCRIPT.
//
// altea divergences:
//  - the editor is TypeScript rather than C# (@altea/altea-eval's EvalLine, which draws Signum's
//    signature / editor / closing-brace sandwich; the C# one read `bool Evaluate(OrderEntity e, WorkflowTransitionContext ctx)`).
...
export default function WorkflowCondition(p: { ctx: TypeContext<WorkflowConditionEntity> }): React.JSX.Element {
    ...
    function handleMainEntityTypeChange(): void {
        ...
        ctx.value.eval ??= WorkflowConditionEval.create({ script: "" });
