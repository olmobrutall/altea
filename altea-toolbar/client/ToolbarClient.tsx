...
import {
    ...
    ToolbarSwitcherOptionEmbedded, type ToolbarLocation,
} from "../data/Toolbar";
...
export namespace ToolbarClient {
    ...
    export function start(cb: ClientBuilder): void {
        ...
        cb.configure(ToolbarElementEmbedded).withView(() => import("./Templates/ToolbarElement"));
        cb.configure(ToolbarMenuElementEmbedded).withView(() => import("./Templates/ToolbarElement"));
        cb.configure(ToolbarSwitcherEntity).withView(() => import("./Templates/ToolbarSwitcher"));
        cb.configure(ToolbarSwitcherOptionEmbedded).withView(() => import("./Templates/ToolbarSwitcherOption"));
