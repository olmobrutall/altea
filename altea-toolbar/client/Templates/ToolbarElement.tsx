...
import {
    ToolbarElementTypeEnum, ShowCountEnum, type ToolbarElementBaseEmbedded, type ShowCount,
} from "../../data/Toolbar";
...
export default function ToolbarElement(p: { ctx: TypeContext<ToolbarElementBaseEmbedded> }): React.JSX.Element {
...
function fixToolbarElementType(a: ToolbarElementBaseEmbedded): void {
